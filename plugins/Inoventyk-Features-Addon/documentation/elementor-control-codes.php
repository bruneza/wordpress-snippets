...
class Elementor_controls_Widget  extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Complex Carousel', 'inoventyk');
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            'code_control_key',
            [
                'label' => esc_html__('Style Codes Section', 'inoventyk'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'label' => esc_html__('Control Label', 'inoventyk'),
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'code_control_key',
            [
                'label' => esc_html__('code_control_label', 'inoventyk'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'code_select_def',
                'options' => [
                    'code_opt1'  => esc_html__('code_opt opt 1', 'inoventyk'),
                    'code_opt1'  => esc_html__('code_opt opt 1', 'inoventyk'),
                ],
                'selectors' => [
        ...
        $this->add_control(
            'show_elements',
            [
                'label' => esc_html__('Show Elements', 'inoventyk'),
                'type' => \Elementor\Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => [
                    'title'  => esc_html__('Title', 'inoventyk'),
                    'description' => esc_html__('Description', 'inoventyk'),
                    'button' => esc_html__('Button', 'inoventyk'),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'label_on' => esc_html__('Show', 'inoventyk'),
                'label_off' => esc_html__('Hide', 'inoventyk'),
                'return_value' => 'yes',
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'color_key',
            [
                'label' => esc_html__('Color', 'inoventyk'),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'background',
                'label' => esc_html__('Background', 'inoventyk'),
        ...
        $this->add_control(
            'widget_title',
            [
                'label' => esc_html__('Title', 'inoventyk'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Default title', 'inoventyk'),
                'placeholder' => esc_html__('Type your title here', 'inoventyk'),
            ]
        );
        ...
        $this->add_control(
            'item_description',
            [
                'label' => esc_html__('Description', 'inoventyk'),
                'type' => \Elementor\Controls_Manager::WYSIWYG,
                'default' => esc_html__('Default description', 'inoventyk'),
                'placeholder' => esc_html__('Type your description here', 'inoventyk'),
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'label' => esc_html__('Box Shadow', 'inoventyk'),
                'selector' => '{{WRAPPER}} .your-class',
            ]
        );
        ...
        $this->start_controls_tab(
            'tab_dot_normal',
            [
                'label' => esc_html__('Normal', 'inoventyk'),
            ]
        );
        ...
        $this->add_control(
            'repeater_key',
            [
                'label' => esc_html__('label', 'inoventyk'),
