...
class Group_INO_Query extends Group_Control_Query
{
    ...
    protected function init_fields_by_name($name)
    {
        ...
        // $fields['related_taxonomies']['condition']['post_type'][] = 'ino-query';
        $fields['include_authors']['condition']['post_type!'][] = 'ino-query';
        $fields['exclude_authors']['condition']['post_type!'][] = 'ino-query';
        $fields['avoid_duplicates']['condition']['post_type!'][] = 'ino-query';

        $fields['post_type']['options']['ino-query'] = esc_html__('INO Query', 'inoventyk');
