...
if (!class_exists('Kura_Scholaships_Filter')) {
	class Kura_Scholaships_Filter  extends \Elementor\Widget_Base
	{
		...
		{
			return 'Kura Scholaships Filter';
		}

		public function get_title()
		{
			return esc_html__('kuraScholashipsFilter', 'kura');
		}
	...
	protected function filter_tab_render(){
		...
		<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					<li class="nav-item" role="presentation">
						<button class="nav-link active" id="all-tab"  type="button" data-bs-toggle="pill" data-bs-target="#all" role="tab" aria-controls="all" aria-selected="true">All</button>
					</li>
					<?php
					...
					foreach ($taxonomies as $key => $cat) {
						...
						<li class="nav-item">
							<button class="nav-link" id="<?php echo $key ?>-tab" type="button" data-bs-toggle="pill" data-bs-target="#<?php echo $key ?>" role="tab" aria-controls="<?php echo $key ?>" aria-selected="false"><?php echo $cat['name'].'('.$cat['post-count'].')'; ?></button>
						</li>
					<?php } ?>
				</ul>
			</div>
		...
		protected function render()
		{
			...
			<div class="kura-scholarship-section  mt-5 mb-3">
			<?php $tabId = $this->filter_tab_render(); ?>
				<div class="tab-content  mt-5 mb-3" id="pills-tabContent">
				<?php
					...
					?>
						...
						<div class="tab-pane fade show " id="<?php echo $tabIndex; ?>" role="tabpanel" aria-labelledby="<?php echo $tabIndex; ?>-tab">
								...
								if ($posts) {
									foreach ($posts as $post) { ?>
										...
										<div class="kura-masonry-item">
											<div class="card light-gray-bg p-4 gx-5">
												<p class="date font-text span-red">
													<?php if ($post['deadline']) echo '<span class="span-red font-weight-bold">Location: </span>' . $post['deadline']; ?>
												</p>
												<h3 class="font-secondary"><?php echo $post['title']; ?></h3>
												<p class="location font-small"><?php echo '<span class="span-red font-weight-bold">Location: </span>' . $post['location']; ?></p>
