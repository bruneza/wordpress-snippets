...
if (!class_exists('Kura_Workshops_Filter')) {
	class Kura_Workshops_Filter  extends \Elementor\Widget_Base
	{
		...
		{
			return esc_html__('Workshops Filter', 'kura');
		}
	...
	protected function filter_tab_render(){
		...
		protected function render()
		{
			...
			<div class="kura-workshop-section">
								...
								if ($posts) {	
									foreach ($posts as $post) { ?>
										...
										<div class="kura-masonry-item">
											...
											<?php k_get_thumbnail($post); ?>												
											<div class="content-wrapper p-4">
													<p class="date font-text">
														<?php echo '<span class="span-red font-weight-bold">Starting: </span>' . $post['starting-date'];
														k_get_duration($post['id'],' | '); ?>
													</p>
